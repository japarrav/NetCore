...
export class AppComponent {
  ...
  //Event Binding desde HTML llamamos a este metodo.
  cambiarTexto(): void{
    this.texto="Proximo video Two way data-binding";
  }

  listRegistros: any[] =[
    {nombre:'Jesus Parra', estado:'Aprendiz'},
    {nombre:'Catalina Perez', estado:'Aprendiz'},
    {nombre:'Juan Pardo', estado:'Expert'},
